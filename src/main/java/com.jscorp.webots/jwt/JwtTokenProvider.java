...
import com.jscorp.webots.responses.StatusResponseBadToken;
...
//    }
    ...
    public Authentication getAuthenticationById(String token) {
        UserDetails userDetails = this.userDetailsService.loadUserById(Long.parseLong(getId(token)));
